...
var Input = function (props) {
    ...
    return (React.createElement("label", { className: files.length > 0 ? labelWithFilesClassName : labelClassName, style: files.length > 0 ? labelWithFilesStyle : labelStyle },
        ...
        React.createElement("input", { className: className, style: style, type: "file", accept: accept, multiple: multiple, disabled: disabled, onChange: function (e) { return __awaiter(void 0, void 0, void 0, function () {
